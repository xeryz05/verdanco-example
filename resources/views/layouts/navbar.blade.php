<div class="navbar-bg" style="background-color: #ecd332 "></div>
<nav class="navbar navbar-expand-lg main-navbar">
    <form class="form-inline mr-auto">
        <ul class="navbar-nav mr-3">
            <li>
                <a href="#" data-toggle="sidebar" class="nav-link nav-link-lg text-dark"
                    ><i class="fas fa-bars mt-3"></i
                ></a>
            </li>
            <li>
                <a
    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown dropdown-list-toggle">
            <a
                ...
                class="nav-link nav-link-lg message-toggle beep text-dark"
        ...
        <li class="dropdown dropdown-list-toggle">
            <a
                href="#"
                data-toggle="dropdown"
                class="nav-link notification-toggle nav-link-lg beep text-dark"
